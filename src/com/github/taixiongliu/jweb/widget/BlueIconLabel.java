...
public class BlueIconLabel extends JWebIconLabel{
	public BlueIconLabel(JWebContext context, String text, String icon, ItemClickHandler onclick) {
	...
	private static JSObject init(String text, String icon, ItemClickHandler onclick){
		...
		btn_opts.setStyle("jweb_blue_icon_label");
		btn_opts.setFocusStyle("jweb_blue_icon_label_focus");
