...
public class GreenIconLabel extends JWebIconLabel{
	public GreenIconLabel(JWebContext context, String text, String icon, ItemClickHandler onclick) {
	...
	private static JSObject init(String text, String icon, ItemClickHandler onclick){
		...
		btn_opts.setStyle("jweb_green_icon_label");
		btn_opts.setFocusStyle("jweb_green_icon_label_focus");
