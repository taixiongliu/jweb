...
public class RedIconLabel extends JWebIconLabel{
	public RedIconLabel(JWebContext context, String text, String icon, ItemClickHandler onclick) {
	...
	private static JSObject init(String text, String icon, ItemClickHandler onclick){
		...
		btn_opts.setStyle("jweb_red_icon_label");
		btn_opts.setFocusStyle("jweb_red_icon_label_focus");
