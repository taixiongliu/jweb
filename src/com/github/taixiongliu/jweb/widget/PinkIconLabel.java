...
public class PinkIconLabel extends JWebIconLabel{
	public PinkIconLabel(JWebContext context, String text, String icon, ItemClickHandler onclick) {
	...
	private static JSObject init(String text, String icon, ItemClickHandler onclick){
		...
		btn_opts.setStyle("jweb_pink_icon_label");
		btn_opts.setFocusStyle("jweb_pink_icon_label_focus");
