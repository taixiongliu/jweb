...
public class YellowIconLabel extends JWebIconLabel{
	public YellowIconLabel(JWebContext context, String text, String icon, ItemClickHandler onclick) {
	...
	private static JSObject init(String text, String icon, ItemClickHandler onclick){
		...
		btn_opts.setStyle("jweb_yellow_icon_label");
		btn_opts.setFocusStyle("jweb_yellow_icon_label_focus");
